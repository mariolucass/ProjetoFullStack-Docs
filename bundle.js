var app = (function () {
  ...
  const He =
    ...
    Ue = function (e, t, n = {}) {
      const r = Te({ className: "comment", begin: e, end: t, contains: [] }, n);
      return (
        r.contains.push(De),
        r.contains.push({
          className: "doctag",
            ...
            ...r.contains.map(function (e) {
              return (function (e) {
                ...
                if (
                  ...
                  return Te(e, { starts: e.starts ? Te(e.starts) : null });
  ...
  function Yt(e, t) {
    ...
    return (
      ...
      i.length &&
        r.push(`CURLOPT_HTTPHEADER => array(\n    ${i.join(",\n    ")}\n  )`),
      (n +=
        r.join(",\n  ") +
      ...
      c() {
        (t = g("div")),
          ...
          v(
            ...
            "class",
            (f =
              c("code-example example-response " + yn(e[16].code)) +
              " svelte-1qvssvw")
          );
      },
      m(e, c) {
    ...
    return {
      c() {
        (t = g("div")),
          ...
          v(r, "id", (i = e[0]._id)),
          v(l, "class", (f = c(e[0].method.toLowerCase()) + " svelte-1qvssvw")),
      ...
      p(e, [t]) {
        (!U || (1 & t && i !== (i = e[0]._id))) && v(r, "id", i),
          ...
          (!U ||
            (1 & t &&
              f !== (f = c(e[0].method.toLowerCase()) + " svelte-1qvssvw"))) &&
            v(l, "class", f),
    ...
    return (
      ...
      (e.$$.update = () => {
        1 & e.$$.dirty && n(5, (r = new Gt(p))),
          ...
          6 & e.$$.dirty && n(12, (s = u && new qt(u, { target: () => d }))),
          4096 & e.$$.dirty &&
            s &&
            s.on("success", function () {
              n(4, (f = "Copied!")),
                setTimeout(() => n(4, (f = "Copy to Clipboard")), 5e3);
            }),
          4096 & e.$$.dirty &&
            s &&
  ...
  class $n extends ue {
    constructor(e) {
      super(),
        ce(this, e, kn, vn, o, { request: 0, language: 8, cookiejars: 9 });
    }
  }
  function En(e, t) {
    return e
    ...
    return (
      ...
      (e.$$set = (e) => {
        "container" in e && n(2, (g = e.container)),
          ...
          "getGroupHeaderLabel" in e && n(46, (j = e.getGroupHeaderLabel)),
      ...
      })),
      {
        c() {
          ...
          (z = b()),
            ...
            j.src !== (I = "https://insomnia.rest/images/run.svg") &&
